            ...
            <div>
                <div className="content-wrapper">
                    <div className="container-fluid">
                        {dataUser[0].role == 1 && <div className="row">
                                                    ...
                                                    {this.state.resign.map((item, key) =>
                                                        <tr key={item.id_resign}>
                                                            ...
                                                            <th>  <button type="button" className="btn btn-light waves-effect waves-light m-1"
                                                                data-toggle="modal" data-target="#formemodaledit" onClick={() => this.setState({ detail: item })}> <i className="fa fa-eye" /></button></th>
                                                            {dataUser[0].role == 1 && <th>  <button type="button" className="btn btn-light waves-effect waves-light m-1"
                                                                onClick={() => this.remove(item)}> <i className="fa fa-trash" /></button></th>}
                                                        </tr>)}
                                                </tbody>
                                            </table>
                                        </div>
